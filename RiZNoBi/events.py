...
from RiZNoBi import MONGO_DB_URI
from RiZNoBi import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"RiZNoBi/modules/{shortname}.py")
        name = "RiZNoBi.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["RiZNoBi.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "RiZNoBi/modules/*.py"
